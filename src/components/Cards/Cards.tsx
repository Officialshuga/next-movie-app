...
// import { getMovie } from "@/utils/apiService";
// import RenderGenre from "../RenderGenre/RenderGenre";
// import { Unmute, Mute } from "@/utils/icons";
...
//             width="100%"
//             height="100%"
//             style={{ borderRadius: ".28rem" }}
//           />
//           <Box sx={{position: "absolute", zIndex: '11', bottom: "10%", right: "5%", }}>
//             <Button Icon={isMute ? Mute : Unmute} rounded onClick={toggleMute}/>
//           </Box>
//         </Box>
//       ) : (
//         <>
